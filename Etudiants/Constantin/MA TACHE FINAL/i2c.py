...
arduinos = [
        ...
        {'id': 4, 'address': 0x15, 'mechanism_status': "NOT_OK", 'ms_timer': 0, 'actuator_status' : {'S_Dragon':"NOT_OK",'S_Fumee':"NOT_OK",'S_Led':"NOT_OK",'S_Feu':"NOT_OK"}, 'as_timer' : 0, 'ordre' : "NOT_OK"},
...
def send_order(arduino):
    if arduino['ordre'] == "OK" :
        socket_message = get_socketMessage()#Fonction Thomas
